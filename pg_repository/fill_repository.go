...
// 	log.Printf("filling org %s with data", orgID)
...
// 	scenarios := make(map[string]app.Scenario)
// 	scenarios["3a6cabee-a565-42b2-af40-5295386c8269"] = scenario
...
// 	//r.organizations[orgID].Scenarios = scenarios
// 	r.organizations[orgID].DataModel = dm

// 	// Ignore error, for duplicate insert
// 	storedScenario, err := r.PostScenario(orgID, scenario)
// 	if err != nil {
// 		fmt.Printf("Error storing scenario: %v", err)
// 		return
// 	}

// 	spew.Dump(storedScenario)
