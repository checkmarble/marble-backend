...
func SerializeDecisionEvaluationDto(nodeEvaluation []*ast.NodeEvaluationDto) ([]byte, error) {
	if nodeEvaluation == nil {
		return nil, nil
	}
...
func DeserializeDecisionEvaluationDto(serializedNodeEvaluationDto []byte) ([]*ast.NodeEvaluationDto, error) {
	if len(serializedNodeEvaluationDto) == 0 {
		return nil, nil
	}
