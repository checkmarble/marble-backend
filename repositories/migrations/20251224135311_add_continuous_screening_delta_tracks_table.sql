...
-- Index to get the latest version of a dataset file for a given org and type
create index idx_cs_dataset_files_type_org_version on continuous_screening_dataset_files (file_type, org_id, version desc);
...
create index idx_cs_delta_tracks_unprocessed_by_org_entity on continuous_screening_delta_tracks (org_id, entity_id, created_at desc) where dataset_file_id is null;
