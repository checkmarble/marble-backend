...
func (e PgExecutor) Exec(ctx context.Context, sql string, args ...any) (pgconn.CommandTag, error) {
	...
	return utils.MeasureLatencyErr(utils.MetricQueryLatency, prometheus.Labels{"org_id": ""}, func() (pgconn.CommandTag, error) {
...
func (e PgExecutor) Query(ctx context.Context, sql string, args ...any) (pgx.Rows, error) {
	...
	return utils.MeasureLatencyErr(utils.MetricQueryLatency, prometheus.Labels{"org_id": ""}, func() (pgx.Rows, error) {
...
func (e PgExecutor) QueryRow(ctx context.Context, sql string, args ...any) pgx.Row {
	...
	return utils.MeasureLatency(utils.MetricQueryLatency, prometheus.Labels{"org_id": ""}, func() pgx.Row {
