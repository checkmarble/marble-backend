...
func (o *organizationSeederImpl) Seed(orgId string) error {
	...
	// 	return err
	// }
	// _, err = o.ScenarioPublicationRepository.CreateScenarioPublication(nil, orgId, models.CreateScenarioPublicationInput{
	// 	ScenarioIterationID: scenarioIteration.ID,
	// 	PublicationAction:   models.Publish,
	// })
	// _, err = o.ScenarioPublicationUsecase.ExecuteScenarioPublicationAction(context.TODO(), models.PublishScenarioIterationInput{
	// 	ScenarioIterationId: scenarioIteration.ID,
	// 	PublicationAction:   models.Publish,
	// })
	if err != nil {
