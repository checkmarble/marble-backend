...
func (suite *MatchEnrichmentWorkerTestSuite) TestWork_OpenSanctionsNotConfigured_Aborts() {
	...
	suite.openSanctionsProvider.On("IsConfigured", suite.ctx, models.ScreeningProviderOpenSanctions).Return(false, nil)
...
func (suite *MatchEnrichmentWorkerTestSuite) TestWork_OpenSanctionsNotSelfHosted_Aborts() {
	...
	suite.openSanctionsProvider.On("IsConfigured", suite.ctx, models.ScreeningProviderOpenSanctions).Return(true, nil)
