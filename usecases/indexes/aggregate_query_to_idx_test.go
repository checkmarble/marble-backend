...
func TestAggregateQueryToIndexFamily(t *testing.T) {
	t.Run("Case with 2 inequality conditions", func(t *testing.T) {
		...
		qFamily := models.AggregateQueryFamily{
			TableName:               "",
			EqConditions:            set.From[models.FieldName]([]models.FieldName{models.FieldName("a"), models.FieldName("b")}),
			IneqConditions:          set.From[models.FieldName]([]models.FieldName{models.FieldName("c"), models.FieldName("d")}),
			SelectOrOtherConditions: set.From[models.FieldName]([]models.FieldName{models.FieldName("e"), models.FieldName("f")}),
		}
		...
		expected := set.HashSetFrom[models.IndexFamily]([]models.IndexFamily{
			{
				...
				Included: set.From[models.FieldName]([]models.FieldName{models.FieldName("d"), models.FieldName("e"), models.FieldName("f")}),
			},
			{
				Fixed:    []models.FieldName{},
				Flex:     set.From([]models.FieldName{models.FieldName("a"), models.FieldName("b")}),
				Last:     models.FieldName("d"),
				Included: set.From[models.FieldName]([]models.FieldName{models.FieldName("c"), models.FieldName("e"), models.FieldName("f")}),
			},
		})
	...
	t.Run("Case with 1 inequality conditions", func(t *testing.T) {
		...
		qFamily := models.AggregateQueryFamily{
			TableName:               "",
			EqConditions:            set.From[models.FieldName]([]models.FieldName{models.FieldName("a"), models.FieldName("b")}),
			IneqConditions:          set.From[models.FieldName]([]models.FieldName{models.FieldName("c")}),
			SelectOrOtherConditions: set.From[models.FieldName]([]models.FieldName{models.FieldName("d"), models.FieldName("e")}),
		}
