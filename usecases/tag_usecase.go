...
type TagUseCaseRepository interface {
	...
	ListInboxTags(tx repositories.Transaction, inboxId string) ([]models.Tag, error)
...
func (usecase *TagUseCase) ListInboxTags(inboxId string) ([]models.Tag, error) {
	...
	return usecase.repository.ListInboxTags(nil, inboxId)
}
...
func (usecase *TagUseCase) DeleteTag(ctx context.Context, inboxId, tagId string) error {
	...
	if err := usecase.repository.SoftDeleteTag(nil, tagId); err != nil {
		return err
	}
